...
echo "------------------------------------------------------------------------------"
echo " "
ssh-copy-id -i ~/.ssh/key_$uid.pub -p $p1 scott$puid1@$paddr1
...
echo "------------------------------------------------------------------------------"
echo " "
ssh-copy-id -i ~/.ssh/key_$uid.pub -p $p2 scott$puid2@$paddr2
...
echo "------------------------------------------------------------------------------"
echo " "
ssh-copy-id -i ~/.ssh/key_$uid.pub -p $p3 scott$puid3@$paddr3
